                ...
                <div class="col-lg-9">
                    <div class="account-content">
                        ...
                        <div class="tab-pane active" id="dashboard">
                            ...
                            <p>Từ trang này, bạn có thể xem các đơn hàng gần đây, quản lý địa chỉ giao hàng và chỉnh sửa
                                thông tin tài khoản.</p>
                            <p>Bạn không phải là {{ $user->email }}? <a href="{{ route('logout') }}"
                                    style="color: red;">Đăng xuất</a></p>
                        </div>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <form
                                                            ...
                                                            @method('PUT')
                                                            <button type="submit"
                                                                class="btn btn-sm btn-warning">Chọn</button>
                                                        </form>
                                                    @endif
                                                </td>
                                                <td>
                                ...
                                <form action="{{ route('account.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center mb-4">
                                            ...
                                            <p style="margin-top: 10px; font-size: 12px; color: #666;">Click vào ảnh để thay
                                                đổi</p>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="ltn__phone_number" id="ltn__phone_number"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" name="ltn__email" id="ltn__email"
                                                value="{{ $user->email }}" readonly style="background: #f5f5f5;">
                                        </div>
