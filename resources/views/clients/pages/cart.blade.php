            ...
            <table class="cart-table">
                ...
                <tbody>
                    ...
                    <tr class="cart-item" data-id="{{ $item->id }}">
                        ...
                        <td class="cart-price">{{ number_format($item->productVariant->price, 0, ',', '.') }} VNĐ</td>
                        <td class="cart-quantity">
                            <div class="quantity-control">
                                <button class="qty-btn decrease" onclick="updateQuantity({{ $item->id }}, -1)">-</button>
                        ...
                        <td class="cart-item-total">{{ number_format($item->productVariant->price * $item->quantity, 0, ',', '.') }} VNĐ</td>
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $(`.cart-item[data-id="${cartItemId}"] .cart-item-total`).text(response.itemTotal + ' VNĐ');
